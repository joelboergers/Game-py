    ...
    #################################################################################################################################
        ...
        def bind_Controls (self) :
            ...
            if self.Server_State == "Host" :
                ...
                self.connect_To_Server(host = "192.168.43.193")
        ...
        def analyze_Message (self,message) :
            ...
            try :
                ...
                if message == "offline" :
                    ...
                    self.Canvas.itemconfig(self.Global_Text, text = "NO CONNECTION")

                    add_To_Chat("[Server] : §4Connection lost")
